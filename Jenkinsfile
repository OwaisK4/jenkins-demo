pipeline {
    ...
    environment {
        ...
        PATH = "C:\\Users\\rayyan.minhaj\\AppData\\Local\\Programs\\Python\\Python312\\python.exe;$PATH"
    }
        ...
        stage('Generate Report') {
            steps {
                script {
                    ...
                    def reportOutput = powershell(script: "& $env:PATH generate_report.py git_diff.txt", returnStdout: true).trim()
